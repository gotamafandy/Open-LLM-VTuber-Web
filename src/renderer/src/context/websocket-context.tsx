...
const DEFAULT_WS_URL = import.meta.env.VITE_WS_URL || 'ws://127.0.0.1:12393/client-ws';
const DEFAULT_BASE_URL = import.meta.env.VITE_BASE_URL || 'http://127.0.0.1:12393';
